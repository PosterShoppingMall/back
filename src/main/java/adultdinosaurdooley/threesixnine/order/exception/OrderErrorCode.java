...
public enum OrderErrorCode {
    ...
    NO_PERMISSION_TO_ORDER("주문 권한이 없습니다.", HttpStatus.FORBIDDEN),
    ...
    CART_PRODUCT_NOT_FOUND("상품정보가 존재하지 않습니다.",HttpStatus.NOT_FOUND),
    ORDER_NOT_FOUND("해당 주문이 존재하지 않습니다.",HttpStatus.NOT_FOUND),
    CHOOSE_PRODUCT("주문할 상품을 선택해주세요.", HttpStatus.BAD_REQUEST),
